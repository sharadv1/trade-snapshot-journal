...
// IMPORTANT: API routes must come before static file handling
// and must explicitly set Content-Type to application/json
// This ensures the client can distinguish between HTML and JSON responses

// Health check endpoint - must be first for connectivity testing
