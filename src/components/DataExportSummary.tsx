...
interface DataExportSummaryProps {
  isOpen: boolean;
  onClose: () => void;
  summaryData: ExportSummaryData;
}

export function DataExportSummary({ isOpen, onClose, summaryData }: DataExportSummaryProps) {
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[700px] max-h-[80vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Summary of all data exported from your trade journal
          </DialogDescription>
        </DialogHeader>
              ...
              <ScrollArea className="h-full">
                <div className="p-4">
                  {summaryData.weeklyReflections.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-muted-foreground">
                      No weekly reflections to export
                    </div>
                  )}
                </div>
              </ScrollArea>
              ...
              <ScrollArea className="h-full">
                <div className="p-4">
                  {summaryData.monthlyReflections.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-muted-foreground">
                      No monthly reflections to export
                    </div>
                  )}
                </div>
              </ScrollArea>
